...
describe Lexiconomitron do
  ...
  describe "#eat_t" do
    it "remove every letter t from the input" do
      expect(@lexi.eat_t("great scott!")).to eq("grea sco!")
    end
  end
  
  describe "shazam" do
    it "reverse words within an array and print first and last word only" do
      expect(@array.shazam[“This”, “is”, “a”, “boring”, “test”]).to eq([“sih, “se”])
     end
  end
end
